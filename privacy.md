...
<div class="container fade-in" style="max-width:900px; margin:auto; padding-top:130px;">
  ...
  <p
    data-en="This website does not actively collect personal data from visitors. However, basic technical data such as IP addresses, browser information, and access timestamps may be processed automatically by third-party services for security, performance, and abuse prevention purposes. No contact forms, user accounts, or direct marketing systems are used."
    data-el="Αυτός ο ιστότοπος δεν συλλέγει ενεργά προσωπικά δεδομένα επισκεπτών. Ωστόσο, βασικά τεχνικά δεδομένα όπως διευθύνσεις IP, πληροφορίες περιήγησης και χρόνος πρόσβασης ενδέχεται να επεξεργάζονται αυτόματα από υπηρεσίες τρίτων για λόγους ασφάλειας, απόδοσης και πρόληψης καταχρήσεων. Δεν χρησιμοποιούνται φόρμες επικοινωνίας, λογαριασμοί χρηστών ή συστήματα άμεσου marketing."
    style="line-height:1.8; margin-bottom:22px;"
  >
  ...
  <p
    data-en="This website does not use advertising or tracking cookies under its own operation. However, essential cookies may be used by infrastructure and security providers such as Cloudflare strictly for security, performance, and functionality purposes."
    data-el="Αυτός ο ιστότοπος δεν χρησιμοποιεί διαφημιστικά ή cookies παρακολούθησης στο πλαίσιο της δικής του λειτουργίας. Ωστόσο, ενδέχεται να χρησιμοποιούνται απαραίτητα cookies από παρόχους υποδομής και ασφάλειας όπως το Cloudflare αποκλειστικά για λόγους ασφάλειας, απόδοσης και λειτουργικότητας."
    style="line-height:1.8; margin-bottom:22px;"
  >
    This website does not use advertising or tracking cookies under its own operation. However, essential cookies may be used by infrastructure and security providers such as Cloudflare strictly for security, performance, and functionality purposes.
  </p>
  ...
  <p
    data-en="This website is hosted on GitHub Pages and uses Cloudflare as a content delivery and security service. These providers may process technical information such as IP addresses and server logs according to their own privacy policies. For more information, please refer to the official privacy policies of GitHub and Cloudflare."
    data-el="Αυτός ο ιστότοπος φιλοξενείται στο GitHub Pages και χρησιμοποιεί το Cloudflare ως υπηρεσία διανομής περιεχομένου και ασφάλειας. Οι υπηρεσίες αυτές ενδέχεται να επεξεργάζονται τεχνικά δεδομένα όπως διευθύνσεις IP και αρχεία καταγραφής σύμφωνα με τις δικές τους πολιτικές απορρήτου. Για περισσότερες πληροφορίες, μπορείτε να ανατρέξετε στις επίσημες πολιτικές απορρήτου του GitHub και του Cloudflare."
    style="line-height:1.8; margin-bottom:22px;"
  >
  ...
  <p
    ...
    data-el="Η επεξεργασία τεχνικών δεδομένων βασίζεται στο έννομο συμφέρον (Άρθρο 6(1)(f) GDPR), με σκοπό τη διασφάλιση της ασφάλειας, της διαθεσιμότητας και της ορθής λειτουργίας του ιστότοπου."
    style="line-height:1.8; margin-bottom:22px;"
  >
  ...
  <p
    data-en="If you have any questions regarding this privacy policy, you can contact me through my social media accounts."
    data-el="Αν έχετε οποιαδήποτε ερώτηση σχετικά με αυτήν την πολιτική απορρήτου, μπορείτε να επικοινωνήσετε μαζί μου μέσω των λογαριασμών μου στα social media."
    style="line-height:1.8; margin-bottom:22px;"
  >
